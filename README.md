...
- **Private commercial MMC1 compatibility fixture: UNPROVEN for playability.** MMC1 is no longer the blocking layer. The current private frontier is translation/control-flow related: undocumented opcode byte `0x7C` at `0xC570`, three unresolved `jmp ($E2)` sites at `0x86E8`, `0x8956` and `0x8F3C`, plus 1,048 candidate instructions in the bank-switched `$8000-$BFFF` window. Native execution and interactive behavior have not been reached for this private title.
